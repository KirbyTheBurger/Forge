...
# Bindings
As you might know, it's not possible to create anything from absolutely nothing (except if you're an atheist). This is why Forge has bindings. Bindings are a set of runtime-native definitions of data and logic. You can view this over at [`docs/bindings.md`](docs/bindings.md).
